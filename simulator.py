...
def time_left(dist):
    ...
    minutes = int(sec/60)
    rest_sec = sec % 60
    message = (str(minutes) + ':' + str(rest_sec))
    return message
...
def run(id, current_coords, from_coords, to_coords, SERVER_URL):
    ...
    while ((from_coords[0] - drone_coords[0])**2 + (from_coords[1] - drone_coords[1])**2)*10**6 > 0.0002:
        print(from_coords, drone_coords)
        dist_left = geopy.distance.geodesic(current_coords, from_coords).km + geopy.distance.geodesic(from_coords, to_coords).km
...
if __name__ == "__main__":
    ...
    #===================================================================
    SERVER_URL = "http://192.168.1.11:5001/drone"
    #===================================================================
